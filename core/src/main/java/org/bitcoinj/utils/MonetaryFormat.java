...
public final class MonetaryFormat {
    ...
    public static final String CODE_BTC = "MBC"; //MBC Jonathan
    /** Currency code for base 1/1000 Bitcoin. */
    public static final String CODE_MBTC = "mMBC";//MBC Jonathan
    /** Currency code for base 1/1000000 Bitcoin. */
    public static final String CODE_UBTC = "µMBC";//MBC Jonathan
